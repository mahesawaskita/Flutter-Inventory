...
class DetailPerbaikanUser extends StatelessWidget {
  ...
  const DetailPerbaikanUser({
    this.itemName = 'Printer',
    this.borrowerName = 'Budi Agung',
    this.status = 'Sedang Dalam Perbaikan',
  });
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _DetailRow(label: 'Nama Pelapor', value: borrowerName),
                    const Divider(),
                    _DetailRow(label: 'Tanggal Laporan', value: '25 Maret 2024'),
                    const Divider(),
                    _DetailRow(label: 'Jenis Kerusakan', value: 'LCD Retak'),
                    const Divider(),
                    Row(
